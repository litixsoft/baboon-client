...
angular.module('lx.transport', ['lx.rest', 'lx.socket'])
    .factory('lxTransport', ['$rootScope', 'REST', 'SocketIO', function ($rootScope, REST, SocketIO) {
         ...
         *
         *      // getAll
         *      transport.emit('wines/getAll', function (error, data){
         *          if (error) {
         *              console.error(error);
         *          } else {
         ...
         *      });
         *
         *      // create data query object for server
         *      var data = {
         *          options: {limit: 100},
         *          query: {country: 'France'}
         *      };
         *
         *      // getAll with options and query data for server
         *      transport.emit('wines/getAll', data, function (error, data){
         *         if (error) {
         *             console.error(error);
         *         } else {
         *             console.log(data.result);
         ...
         *      });
         *
         * @return {{emit: Function}} transport object with function emit (fire events to server)
         */
