...
angular.module('lx.charts', [])
    ...
    .controller('LxChartsCtrl', ['$scope', '$element', '$attrs', 'lxChartsColorUtil', 'lxChartsConfig', '$log',
        function (scope, element, attrs, util, cfg, $log) {
            ...
            scope.dim1 = null;             //first dimension of the the data for example: 'name'
            scope.dim2 = null;             //second dimension of the the data for example: '2012'
            scope.sortPieces = null;       //string: 'descending' or 'ascending' specifies the sort direction
            scope.alignPieces = null;      //boolean: true if the thickness of the peaces should be the same although the value divers and would result in different thicknesses
            scope.keyValue = true;
            scope.keys = [];
            scope.max = 0;
            scope.name = '';
...
//
            ...
            function startUpdate () {
                ...
                if (scope.chartType === 'bars') {
                    ...
                    $log.log('Fehler: Kein Chart-Type definiert! Bitte geben sie einen der folgenden Typen an, "bars", "ring"');
                }
